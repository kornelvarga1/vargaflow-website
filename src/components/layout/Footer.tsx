        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/reviews" className="text-sm text-muted-foreground hover:text-primary">Reviews</Link></li>
          ...
          <div>
            ...
            <a href={`mailto:${SITE_EMAIL}`} className="text-sm text-muted-foreground hover:text-primary">
              {SITE_EMAIL}
            </a>
            <div className="mt-6">
              <Link
