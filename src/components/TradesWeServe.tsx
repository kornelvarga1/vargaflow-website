          ...
          <div className={`mt-14 grid gap-5 ${compact ? "grid-cols-2 sm:grid-cols-4" : "grid-cols-2 sm:grid-cols-3 lg:grid-cols-4"}`}>
            {trades.map((trade) => {
              ...
              return (
                <div
                  key={trade.name}
                  className="group flex flex-col items-center gap-4 rounded-xl border border-border bg-background p-8 text-center transition-colors duration-300 hover:border-foreground/30"
                >
